    ...
    <div className="login-page">
      <section className="login-art">
        <div className="login-copy">
          <div className="eyebrow">COLLEGIATE VENDAS // OPERAÇÃO ATIVA</div>
          <h1>Sexta<br/>Marcha</h1>
          <p>Disciplina gera resultado. Resultado gera liberdade.</p>
        </div>
      </section>
      <section className="login-panel">
        <form className="login-box">
          ...
          <p>Entre no centro de operações para acompanhar metas, configurar seu loadout e acessar o esquadrão.</p>
